...
> Forked from [Doikki/DKVideoPlayer](https://github.com/Doikki/DKVideoPlayer)  
> Support API >= 28 (Android 9+)  
> Support 16KB alignment (uses [ant-media/LibRtmp-Client-for-Android](https://github.com/ant-media/LibRtmp-Client-for-Android) library for replacement)  
> Migrate ExoPlayer to Media3  
> Replace IjkPlayer to the artifact of [debugly/ijkplayer](https://github.com/debugly/ijkplayer)
